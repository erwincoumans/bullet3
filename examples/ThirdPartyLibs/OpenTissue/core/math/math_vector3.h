...
namespace OpenTissue
{
  ...
  namespace math
  {
    ...
    public:
      ...
      friend Vector3 min1( Vector3 const & A, Vector3 const & B )
      {
        using std::min;
        return Vector3( min1( A(0), B(0) ), min1( A(1), B(1) ), min1( A(2), B(2) ) );
      }

      friend Vector3 max1( Vector3 const & A, Vector3 const & B )
      {
        using std::max;
        return Vector3( max1( A(0), B(0) ), max1( A(1), B(1) ), max1( A(2), B(2) ) );
      }
